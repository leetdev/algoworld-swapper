...
with open("misc/clone_badge/clone.json", "r") as fh:
    now = json.load(fh)

with open("misc/clone_badge/clone_before.json", "r") as fh:
    before = json.load(fh)
...
with open("misc/clone_badge/clone.json", "w", encoding="utf-8") as fh:
